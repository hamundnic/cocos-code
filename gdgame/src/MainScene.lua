...
function MainScene:init()
    ...
    local bg2 = ct.MaskSprite:create("ui/main_bg_mountain.jpg")
...
--    gd.CustomClass:create():helloMsg()
    ...
    local bg3 = ct.MaskSprite:create("ui/main_bg_grass_left.jpg")
    ...
    local bg4 = ct.MaskSprite:create("ui/main_bg_grass_right.jpg")
    ...
    --add menu
--    local item1Sprite = ct.MaskSprite:create("ui/main_menu_todolist_1.jpg")
--    item1Sprite:setMask("ui/main_menu_todolist_1_alpha_mask",gd.maskVSH,gd.maskFSH)
--    local item1SpriteSelect = ct.MaskSprite:create("ui/main_menu_todolist_2.jpg")

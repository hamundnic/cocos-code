...
--------------------------------
-- @function [parent=#TableView] setDelegate 
-- @param self

--------------------------------
-- @function [parent=#TableView] setDataSource 
-- @param self

--------------------------------
-- @function [parent=#TableView] create 
-- @param self
-- @param #size_table size
-- @param #cc.Node node

--------------------------------
-- @function [parent=#TableView] registerScriptHandler 
-- @param self
-- @param #function handler
-- @param #int type

--------------------------------
-- @function [parent=#TableView] unregisterScriptHandler 
-- @param self
-- @param #int type

...
--------------------------------
-- @function [parent=#PhysicsBody] getJoints 
-- @param self
-- @return table#table ret (return value: point_table)

--------------------------------
-- @function [parent=#PhysicsBody] createPolygon 
-- @param self
-- @param #points_table arg1
-- @param #materail_table arg2
-- @param #point_table arg3
-- @return PhysicsBody#PhysicsBody ret (return value: cc.PhysicsBody)

--------------------------------
-- @function [parent=#PhysicsBody] createEdgePolygon 
-- @param self
-- @param #points_table arg0
-- @param #materail_table arg1
-- @param #double arg2
-- @return PhysicsBody#PhysicsBody ret (return value: cc.PhysicsBody)

--------------------------------
-- @function [parent=#PhysicsBody] createEdgeChain 
-- @param self
-- @param #points_table arg0
-- @param #materail_table arg1
-- @param #double arg2
...
--------------------------------
-- @function [parent=#PhysicsBody] recenterPoints 
-- @param self
-- @param #points_table arg0

...
int lua_cocos2dx_masksprite_MaskSprite_testBindingIsOK(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_masksprite_MaskSprite_testBindingIsOK'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_cocos2dx_masksprite_MaskSprite(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"MaskSprite");
        ...
        tolua_function(tolua_S,"testBindingIsOK", lua_cocos2dx_masksprite_MaskSprite_testBindingIsOK);
